...
return new class extends Migration
{
    ...
    {
        Schema::create('venta_consolidadas', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum("estado_gestion",['PENDIENTE','PAGADO'])->default('PENDIENTE');
    ...
    {
        Schema::dropIfExists('venta_consolidadas');
    }
};
