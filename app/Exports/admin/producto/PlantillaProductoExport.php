...
namespace App\Exports\admin\producto;
...
class PlantillaProductoExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize, WithDefaultStyles
{
   public function collection()
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // Ajuste de alineación de la columna C a la izquierda
